# EXCEL_Dashboard
Pizza Portfolio Dashboard

A dynamic and interactive Pizza Portfolio Dashboard built using Microsoft Excel, designed to provide actionable insights into sales performance. This dashboard leverages Excel's powerful features to visualize key sales metrics, helping businesses track progress and make informed decisions.

Features:
Interactive Visualizations: Dynamic charts and graphs to represent Pizza trends.
